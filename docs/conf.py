...
# -*- coding: utf-8 -*-
#
# niworkflows documentation build configuration file, created by
...
latex_documents = [
  ('index', 'niworkflows.tex', 'shablona Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'niworkflows', 'shablona Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'niworkflows', 'shablona Documentation',
   'Ariel Rokem', 'niworkflows', 'One line description of project.',
   'Miscellaneous'),
]
