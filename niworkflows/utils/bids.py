...
def check_pipeline_version(cvers, data_desc):
    ...
    Returns a warning string if there is a difference between versions, otherwise ``None``.
    ...
    >>> with open('sample_dataset_description.json', 'wt') as fp:
    ...     json.dump(data, fp)
    ...
    >>> check_pipeline_version('1.1.1', 'sample_dataset_description.json')
