...
def check_pipeline_version(cvers, data_desc):
    ...
    Produces a warning if there is a difference between versions.

    Parameters
    ----------
    cvers : :obj:str
        Current pipeline version
    data_desc : :obj:str or Pathlike
    ...
    if Version(cvers) != Version(dvers):
        warnings.warn("Previous output generated by version {} found.".format(dvers))
