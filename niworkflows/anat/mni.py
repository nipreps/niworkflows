...
def make_cfm(ref_mask, out_path, lesion_mask, whole_img=True):
    """
    ...
    if whole_img is True:
        ...
        ref_data[:] = 1
        # Replace the original reference mask image.
